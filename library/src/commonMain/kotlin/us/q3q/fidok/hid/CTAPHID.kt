...
class CTAPHID {
    companion object {
        ...
        private suspend fun readIgnoringKeepalives(
            channel: UInt,
            cmd: CTAPHIDCommand,
        ...
        suspend fun sendToChannel(
            ...
            bytes: ByteArray,
            packetSize: Int,
            sender: suspend (bytes: ByteArray) -> Unit,
        ) {
