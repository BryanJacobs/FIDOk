...
class EZHmacTest : SimulationTest() {
    ...
    @Test
    fun rotationIsSameAsTwoEncrypts() {
        ...
        runBlocking {
            ...
            val rotation = ezHmac.encryptAndRotate(setup, toEncrypt, salt1, salt2)

            assertContentEquals(toEncrypt, ezHmac.decrypt(setup, rotation.first, salt1))
